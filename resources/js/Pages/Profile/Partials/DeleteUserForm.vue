    ...
    <section class="space-y-6">
        <header>
            ...
            <p class="mt-1 text-sm text-gray-600">
                Una vez que se elimine tu cuenta, todos sus datos y recursos se eliminarán de forma permanente.
        ...
        <Modal :show="confirmingUserDeletion" @close="closeModal">
            <div class="p-6">
                ...
                <p class="mt-1 text-sm text-gray-600">
                    Una vez que se elimine tu cuenta, todos sus datos y recursos se eliminarán de forma permanente.
                    Por favor, ingresa tu contraseña para confirmar que deseas eliminarla de manera definitiva.
                </p>
